module.exports = {
	...
	checkVariables() {
		try {
			...
			variableObj.plan_currentitem_time_remaining_seconds = this.currentState.dynamicVariables.plan_currentitem_time_remaining_seconds;
			variableObj.plan_currentitem_time_shouldfinish = this.currentState.dynamicVariables.plan_currentitem_time_shouldfinish;

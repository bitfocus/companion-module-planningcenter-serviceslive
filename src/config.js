	...
	getConfigFields() {
		return [
			...
			},
			{
				...
				label: 'Information',
				value:
					'You will need to setup a Personal Access Token in your PCO account. More info <a href="https://api.planningcenteronline.com/oauth/applications">here</a>',
			},
			{
				type: 'textinput',
				id: 'applicationid',
			...
			},
			{
				...
				label: 'Polling',
				value:
					'Enabling polling will allow for better feedbacks and variables, however it may cause the API to be rate-limited.',
			},
			{
				type: 'checkbox',
				label: 'Polling',
			...
			},
			{
				...
				id: 'pollingRate',
				tooltip:
					'The polling rate does not need to be very fast. 3000ms is recommended. A faster rate may cause the API to be rate-limited.',
				width: 2,
				min: 1000,
				max: 30000,
				default: 3000,
